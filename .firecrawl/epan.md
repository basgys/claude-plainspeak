[Skip to main content](https://arxiv.org/abs/2607.21498#content)[![archive](https://arxiv.org/static/base/1.0.1/images/arxiv-logo-primary-light.svg)](https://arxiv.org/)[Search](https://arxiv.org/search) [Submit](https://arxiv.org/user/create) [Donate](https://info.arxiv.org/about/donate.html) [Log in](https://arxiv.org/login)
...
\[Submitted on 23 Jul 2026 ( [v1](https://arxiv.org/abs/2607.21498v1)), last revised 28 Jul 2026 (this version, v2)\]

# Title:Artificial Epanorthosis: Why large language models overuse a classical rhetorical figure, and how to mitigate it

Authors: [Federico Boggia](https://arxiv.org/search/cs?searchtype=author&query=Boggia,+F)
...
[View PDF](https://arxiv.org/pdf/2607.21498) [HTML (experimental)](https://arxiv.org/html/2607.21498v2)
...
|     |     |
| --- | --- |
| Comments: | 18 pages, 7 tables. v2: corrections to the classical sources (Quintilian, Cicero) and to several cited figures, and Appendix B corpus statistics aligned to the delivered dataset; measurements, results and conclusions unchanged. Data, code, and the trained LoRA adapter: [this https URL](https://federicoboggia.binatomy.com/pubblicazioni/) |
| Subjects: | Computation and Language (cs.CL); Artificial Intelligence (cs.AI) |
| Cite as: | [arXiv:2607.21498](https://arxiv.org/abs/2607.21498) \[cs.CL\] |
|  | (or [arXiv:2607.21498v2](https://arxiv.org/abs/2607.21498v2) \[cs.CL\] for this version) |
|  | [https://doi.org/10.48550/arXiv.2607.21498](https://doi.org/10.48550/arXiv.2607.21498)<br>Focus to learn more<br>arXiv-issued DOI via DataCite |

## Submission history

From: Federico Boggia \[ [view email](https://arxiv.org/show-email/0f5755f7/2607.21498)\]

**[\[v1\]](https://arxiv.org/abs/2607.21498v1)**
Thu, 23 Jul 2026 16:47:39 UTC (26 KB)

**\[v2\]**
Tue, 28 Jul 2026 14:30:09 UTC (27 KB)
...
- [View PDF](https://arxiv.org/pdf/2607.21498)
- [HTML (experimental)](https://arxiv.org/html/2607.21498v2)
- [TeX Source](https://arxiv.org/src/2607.21498)
...
[< prev](https://arxiv.org/prevnext?id=2607.21498&function=prev&context=cs.CL "previous in cs.CL (accesskey p)")  \|  [next >](https://arxiv.org/prevnext?id=2607.21498&function=next&context=cs.CL "next in cs.CL (accesskey n)")
...
[cs](https://arxiv.org/abs/2607.21498?context=cs)

[cs.AI](https://arxiv.org/abs/2607.21498?context=cs.AI)

### References & Citations

- [NASA ADS](https://ui.adsabs.harvard.edu/abs/arXiv:2607.21498)
- [Google Scholar](https://scholar.google.com/scholar_lookup?arxiv_id=2607.21498)
- [Semantic Scholar](https://api.semanticscholar.org/arXiv:2607.21498)

export BibTeX citation

### Bookmark

[![BibSonomy](https://arxiv.org/static/browse/0.3.4/images/icons/social/bibsonomy.png)](http://www.bibsonomy.org/BibtexHandler?requTask=upload&url=https://arxiv.org/abs/2607.21498&description=Artificial%20Epanorthosis:%20Why%20large%20language%20models%20overuse%20a%20classical%20rhetorical%20figure,%20and%20how%20to%20mitigate%20it "Bookmark on BibSonomy") [![Reddit](https://arxiv.org/static/browse/0.3.4/images/icons/social/reddit.png)](https://reddit.com/submit?url=https://arxiv.org/abs/2607.21498&title=Artificial%20Epanorthosis:%20Why%20large%20language%20models%20overuse%20a%20classical%20rhetorical%20figure,%20and%20how%20to%20mitigate%20it "Bookmark on Reddit")
...
[Which authors of this paper are endorsers?](https://arxiv.org/auth/show-endorsers/2607.21498) \|
